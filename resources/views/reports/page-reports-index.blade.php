            ...
            @foreach($reports['lost']['data'] as $item)
              <li>
                ...
                <div class="edit_menu_div">   
                    ...
                    <p class="enlace _item_{{ $item['id'] }}" onclick="item_finded_pet({{ $item['id']}});"><img class="edit_icon" src="{{ asset('img/icon-smile-face.png') }}"/>&emsp;<span style="font-size: 14px;">Encontrado</span></p>                    
                    </div>
                </div>
              </li>
              @endforeach
