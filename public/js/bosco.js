...
var locationsCountry2 = $('#ubigeo-department2');
locationsCountry2.on('change', function (e) {
    e.preventDefault();
    var $this = $(this);
    console.log($this.val());
    if ($this.val() == "Todos") {
        $("#ubigeo-city2").html('<option value="" default style="display:none;">-----</option>').fadeIn();
        $("#ubigeo-district2").html('<option value="" default style="display:none;">-----</option>').fadeIn();
        $('#ubigeo-city2').addClass('error');
        $('#ubigeo-district2').addClass('error');
        var department = "Todos";
        var city = "";
        var district = "";
        $.ajax({
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.result) {
                    $('#ubigeo-city2').html(data.options).fadeIn();
                    $("#ubigeo-city2").append('<option value="Todos">Todos</option>');
                    $('#ubigeo-district2').html('<option value="" default style="display:none;">Distrito</option>').fadeIn();
                    $("#ubigeo-district2").append('<option value="Todos">Todos</option>');
                    $('#ubigeo-city2').addClass('error');
                    $('#ubigeo-district2').addClass('error');
                }
            }
...
//end of ubigeo departments recently
...
//ubigeo city recently


var locationsCity2 = $('#ubigeo-city2');
locationsCity2.on('change', function (e) {
    e.preventDefault();
    var $this = $(this);
    if ($this.val() == "Todos") {
        $("#ubigeo-district2").html('<option value="" default style="display:none;">-----</option>').fadeIn();
        var department = $('#ubigeo-department2').val();
        var city = "Todos";
        var district = "";
        $.ajax({
            type: "GET",
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.result) {
                    $('#ubigeo-district2').html(data.options).fadeIn();
                    $("#ubigeo-district2").append('<option value="Todos">Todos</option>');
                    $('#ubigeo-district2').addClass('error');
                }
            }
...
//ubigeo district recently
var locationsDistrict2 = $('#ubigeo-district2');
locationsDistrict2.on('change', function (e) {
    var department = '';
    var city = '';
    if ($("#ubigeo-district2").val() == "Todos") {
        var department = $("#ubigeo-department2").val();
        var city = $("#ubigeo-city2").val();
    }

    var district = $('#ubigeo-district2').val();
    $.ajax({
        type: "GET",
        url: window.location.origin + '/search-pets',
        dataType: 'json',
...
//end of ubigeo district recently 
            ...
            function (results, status) {
                if (status == google.maps.GeocoderStatus.OK) {
                    if (results[0]) {
                        ...
                        document.getElementById('pac-address').value = city + " " + district + " " + street_number;
...
var updateListPets = function() {
    var perros =  '<option value="Alano"><option value="Alaskan Malamute" ><option value="American Staffordshire Terrier"><option value="American Water Spaniel"><option value="Antiguo Pastor Inglés">    <option value="Basset Azul Gaseogne"><option value="Basset Hound">    <option value="Basset leonado">    <option value="Beagle"><option value="Bearded Collie"><option value="Bichón Maltés"><option value="Bobtail"><option value="Border Collie"><option value="Boston Terrier"> <option value="Boxer"><option value="Bull Terrier"><option value="Bulldog Americano"><option value="Bulldog Frances"><option value="Bulldog Ingles"><option value="Caniche"><option value="Carlino"><option value="Chihuahua"><option value="Cirneco del Etna"><option value="Chow Chow"><option value="Cocker Spaniel Americano"><option value="Cocker Spaniel Ingles"><option value="Dalmata"><option value="Dobermann"><option value="Dogo Alemán"><option value="Dogo Argentino"><option value="Dogo de Burdeos"><option value="Finlandes"><option value="Fox Terrier pelo liso"><option value="Fox Terrier"><option value="Foxhound Americano"><option value="Foxhound Ingles"><option value="Galgo Afgano"><option value="Gigante Pirineos"><option value="Golden Retriever"><option value="Gos d Atura"><option value="Gran Danes"><option value="Husky Siberiano"><option value="Laika Siberia"><option value="Laika Ruso-europeo"><option value="Labrador"><option value="Mastin del Pirineo"><option value="Mastin del Tibet"><option value="Mastín Español"><option value="Mastin Napolitano"><option value="Pastor Aleman"><option value="Pastor Australiano"><option value="Pastor Belga"><option value="Pastor de Brie"><option value="Pastor de Cara Rosa"><option value="Pekines"><option value="Perdiguero Chesapeake"><option value="Perdiguero Pelo Liso"><option value="Perdiguero Rizado"><option value="Perdiguero Portugues"><option value="Pitbull"><option value="Podenco Ibicenco"><option value="Podenco Portugues"><option value="Presa Canario"><option value="Presa Mallorquin">    <option value="Rottweiler"><option value="Rough Collie"><option value="Sabueso Español"><option value="Sabueso Hélenico"><option value="Sabueso Italiano"><option value="Sabueso Suizo"><option value="Samoyedo"><option value="San Bernardo"> <option value="Scottish Terrier"> <option value="Setter Irlandés"><option value="Shar Pei"> <option value="Shiba Inu"> <option value="Staffordshire Bull Terrier"><option value="Teckel"><option value="Terranova"><option value="Terrier Australiano"><option value="Terrier Escocés"> <option value="Terrier Irlandés"><option value="Terrier Japonés"><option value="Terrier Negro Ruso"><option value="Terrier Norfolk"><option value="Terrier Norwich"><option value="Yorkshire Terrier">';
    var gatos = "<option value='Abisinio'><option value='American Curl'> <option value='Azul ruso'><option value='American shorthair'><option value='American wirehair'><option value='Angora turco'><option value='Africano doméstico'><option value='Bengala'><option value='Bobtail japonés'><option value='Bombay'><option value='Bosque de Noruega'><option value='Brazilian Shorthair'><option value='Brivon pelo corto'><option value='Brivon pelo largo'><option value='British Shorthair'><option value='Burmés'><option value='Burmilla'><option value='Cornish rex'><option value='California Spangled'><option value='Ceylon'><option value='Cymric'><option value='Chartreux'><option value='Deutsch Langhaar'><option value='Devon Rex'><option value='Dorado africano'><option value='Don Sphynx'><option value='Dragon Li'><option value='Europeo Común'><option value='FoldEx'><option value='German Rex'><option value='Habana brown'><option value='Himalayo'>    <option value='Korat'><option value='Khao Manee'><option value='Maine Coon'><option value='Manx'><option value='Mau egipcio'><option value='Munchkin'><option value='Ocicat'><option value='Oriental'><option value='Ojos azules'><option value='PerFold1'><option value='Persa Americano'><option value='Persa Clásico'><option value='Peterbald'><option value='Pixie Bob'><option value='Ragdoll'><option value='Sagrado de Birmania'><option value='Scottish Fold'><option value='Selkirk rex'><option value='Serengeti'><option value='Seychellois'><option value='Siamés'><option value='Siamés Moderno'><option value='Siamés Tradicional'><option value='Siberiano'><option value='Snowshoe'><option value='Sphynx'><option value='Tonkines'><option value='Van Turco'>";
    if ($("#lost_pet_type").val() == "perro") {
        console.log('entra en 1'); 
        $("#mascotasl").html(perros);
    } else {
        console.log('entra en 2');
        $("#mascotasl").html(gatos);
    }
}
...
var gallerySize = function() {
    var acum = 15;
    $('.pets-list').children().each(function(){
        acum += $(this).width();
    });
    return acum;
};
$('.next-gallery-btn').click(function () {
    ...
    if (Number(gallerySize()) + prev_pos_gallery > 115) {
        prev_pos_gallery -= $('.pets-list').width() / 7; //una septima parte de lo que muestre en pantalla
    }
...
$('.prev-gallery-btn').click(function(){
    ...
    if (prev_pos_gallery < -15) 
        prev_pos_gallery += $('.pets-list').width()/7; //una septima parte corre para mas velocidad
    $('.pets-list').animate({ left: prev_pos_gallery + 'px' }, 1000, function () {
        if (prev_pos_gallery > -15) 
            $('.prev-gallery-btn').hide();
    });
